...
| PMD 85-3 TV/CV        | org.retroconverter.tesla.pmd85-3.tv      | pmd85-3-tv     | 6×1      | Four static gray levels    |
...
| **Bits 7–6** | **PMD 85-2 TV/CV** | **PMD 85-2 RGB mod** | **PMD 85-3 TV/CV** | **PMD 85-3 PAL/video** | **PMD 85-3 RGB** |
|--------------|--------------------|----------------------|--------------------|------------------------|------------------|
| 00           | Bright             | Green                | White              | White                  | Green            |
| 01           | Dim                | Yellow               | Light gray         | Green                  | Red              |
| 10           | Bright + blink     | Cyan                 | Gray               | Red                    | Blue             |
| 11           | Dim + blink        | White                | Dark gray          | Brown                  | Magenta          |
...
| Display aspect       | 288:256 (9:8) for the active raster with square (1:1) pixels.                                                                                |
| Pixel aspect ratio   | PMD 85 pixels are square (1:1). Display the 288×256 active raster without aspect correction. |
...
| Profiles              | Register the six built-in hardware interpretations in apps/web/src/profiles.ts; keep palette calibration profile-owned.                 |
...
- Exact CRT active-area timing remains out of scope; PMD 85 preview and conversion use the specified square-pixel active raster.
