...
const passthroughObject = <T>(fallback: T) => (value: unknown): T | null =>
...
export const SETTINGS_REGISTRY: readonly SettingDefinition[] = [
  ...
  { id: "customOrderedMatrices", category: "dithering", label: "Custom ordered matrices", description: "Stored user-defined ordered matrices for the composer.", scope: "conversion", control: { kind: "readonly" }, defaultValue: DEFAULT_CONVERSION_SETTINGS.customOrderedMatrices, validate: passthroughObject(DEFAULT_CONVERSION_SETTINGS.customOrderedMatrices) },
  { id: "customDiffusionKernels", category: "dithering", label: "Custom diffusion kernels", description: "Stored user-defined diffusion kernels for the composer.", scope: "conversion", control: { kind: "readonly" }, defaultValue: DEFAULT_CONVERSION_SETTINGS.customDiffusionKernels, validate: passthroughObject(DEFAULT_CONVERSION_SETTINGS.customDiffusionKernels) },
  { id: "composer", category: "dithering", label: "Composer settings", description: "Pattern, propagation, mix, and carrier settings for dither composer v1.", scope: "conversion", control: { kind: "readonly" }, defaultValue: DEFAULT_CONVERSION_SETTINGS.composer, validate: passthroughObject(DEFAULT_CONVERSION_SETTINGS.composer) },
